...
# ---------------------------------------------------------------------------
VIDEO_URL = os.environ.get("VIDEO_URL", "http://10.71.1.159:8080/video")
...
SERVER_URL = "http://127.0.0.1:5000"   # change to server's LAN IP if running
                                        # detection on a different device than
                                        # the server, e.g. "http://192.168.31.50:5000"
